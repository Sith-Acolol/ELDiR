...
def simulate_pop(pop_file, gen_dir, device_ids, ground_samples_file, debug):
    ...
    for i, (start, end) in enumerate(worker_indices):
        ...
        args = (pop_file, gen_dir, device_id, ground_samples_file, log_file, start, end, seed, debug)
